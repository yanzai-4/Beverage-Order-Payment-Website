package com.example.springpaymentsapi.service;
...
import com.example.springpaymentsapi.repository.PaymentsRepository;
...
public class PaymentsService {
    ...
    @Autowired private PaymentsRepository Repository;
    ...
    @Value("${cybersource.apihost}") private String requestHost ;
    ...
    public String postRequestTarget = "REQUEST_TARGET_PALCEHOLDER";
    public String APINAME = "APINAME_PLACEHOLDER";
    public String resource = "resource_PLACEHOLDER";
    public String payload = null;
    public AuthRequest temp = null;
    ...
    */
    ...
    private PostResponse sendPost(String url) {
        ...
        try {
            ...
            res.response = response.toString() ;
            if (DEBUG) System.out.println("6 OK") ;
            return res ;
        }
    }
